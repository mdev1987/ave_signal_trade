...
async def _trade_loop(
    ...
    trader = PaperTrader(
        ...
        name_collision_policy=s.name_collision_policy,
        name_collision_window_s=s.name_collision_window_s,
        flat_after_s=s.flat_exit_after_s,
        flat_max_gain_pct=s.flat_max_gain_pct,
        trading_hours_utc=s.trading_hours_utc,
        partial_tp_mult=s.partial_tp_mult,
        partial_tp_fraction=s.partial_tp_fraction,
