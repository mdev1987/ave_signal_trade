...
| `LIQ_UNCHECKED_JOURNAL_ONLY` | true | Blind opens journal-only (28 closes -0.097 paper 2026-09-12..16; cap didn't fix expectancy) |
| `LIQ_UNCHECKED_MAX_SOL` | 0.02 | Cap for blind opens when journal-only is false |
